...
// This code changes the color of neopixels
// using an IR remote control
//left most pin on IR receiever goes to pin d4
//middle pin goes to ground
//right most pin goes to 5v

#define RECV_PIN 11  // define sensor pin 11
